...
import { incrementViolation } from "../redux/slices/testSlice";
...
const Test = () => {
  ...
  useEffect(() => {
    ...
    const handleCopy = (e) => {
      e.preventDefault(); // Block the copy
  ...
  const handleViewLogs = () => {
    // Flush events before viewing logs
    if (eventLoggerRef.current) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="card p-6 mb-6 border-l-4 border-orange-400">
